...
namespace RaidHelper
{
    class ArtifactListClass
    {
        ...
        public ArtifactListClass(TextBox textBox, ListView viewToHandle)
        {
            ...
            int[] ArtifactListPointers = new int[] { 0xb8, 0x0, 0x0 };
            Base = ProcessApi.FindDMAAddy(Globals.Handle, Globals.Base + 0x036E42D8, ArtifactListPointers);
        ...
        public IntPtr ArtifactsPointerList()
        {
            ...
            NewClass = ProcessApi.FindDMAAddy(Handle, Base + 0x10, new int[] { 0x18, 0x10, 0x10, 0x0 });
            return NewClass;
        }
