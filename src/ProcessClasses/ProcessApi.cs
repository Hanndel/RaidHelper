...
namespace RaidHelper
{
	class ProcessApi
	{
		...
		IntPtr hProcess, IntPtr lpBaseAddress, byte[] lpBuffer, Int32 nSize, out int lpNumberOfBytesRead);

		[DllImport("kernel32.dll", SetLastError = true)]
		public static extern bool WriteProcessMemory(
#pragma warning disable CS0618 // Type or member is obsolete
		IntPtr hProcess, IntPtr lpBaseAddress, [MarshalAs(UnmanagedType.AsAny)] object lpBuffer, Int32 nSize, ref int lpNumberOfBytesWritten);
#pragma warning restore CS0618 // Type or member is obsolete
		...
		public static IntPtr FindMultiLevelPointer(IntPtr hProc, IntPtr ptr, int[] offsets)
		{
			...
			{
				int read = 0;
				ReadProcessMemory(hProc, ptr + i, buffer, buffer.Length, out read);
